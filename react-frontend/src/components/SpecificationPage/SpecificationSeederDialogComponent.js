...
import seederData from "./specification.seeder.json";
...
const SpecificationSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(SpecificationSeederDialogComponent);
